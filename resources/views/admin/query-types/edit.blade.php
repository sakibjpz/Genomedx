...
<div class="container mx-auto p-4 max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Query Type</h1>

        <form action="{{ route('admin.query-types.update', $queryType->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $queryType->name) }}" required
            ...
            <div class="mb-6">
                ...
                <input type="text" id="display_name" name="display_name" 
                       value="{{ old('display_name', $queryType->display_name) }}" required
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                <p class="text-sm text-gray-500 mt-1">
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Brief description of this query type">{{ old('description', $queryType->description) }}</textarea>
            </div>
                ...
                <select id="team_id" name="team_id" required
                    ...
                    @foreach($teams as $team)
                        <option value="{{ $team->id }}" 
                            {{ $queryType->team_id == $team->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                ...
                <input type="number" id="sort_order" name="sort_order" 
                       value="{{ old('sort_order', $queryType->sort_order) }}"
